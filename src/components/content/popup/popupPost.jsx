...
function PopupPost({ onClose, userInfo }) {
  ...
  const [isPosting, setIsPosting] = useState(false); // Tránh spam
      ...
      <div className="w-[533px] bg-white rounded-lg shadow-lg p-5 relative">
        ...
        <div className="flex items-center">
          ...
          <div className="flex flex-col ml-2">
            ...
            <select
              className="p-1 rounded bg-gray-300 border-none outline-none"
        ...
        <button
          className={`w-full text-center bg-blue-600 text-white text-lg py-2 rounded-md mt-2 ${
